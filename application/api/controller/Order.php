...
use app\admin\controller\setting as SettingModel;
/**
 * 订单控制器
 * Class Order
...
class Order extends Controller
{
    ...
    {
        $small = SettingModel::getItem('small');
        $small_pay = SettingModel::getItem('small_pay');
        $wxConfig = array_merge($small,$small_pay);
