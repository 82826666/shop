                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">编辑招聘</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">招聘名称 </label>
                                        ...
                                        <div class="uploader-list am-cf">
                                            <?php if ($model['image']): ?>
                                                <div class="file-item">
                                                    ...
                                                    <input type="hidden" name="recruit[image_id]"
