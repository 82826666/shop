                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require"> AppID 小程序ID </label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" name="small[app_id]"
                                           value="<?= $values ? $values['app_id'] : '' ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require"> AppSecret 小程序密钥 </label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input"
                                           name="small[app_secret]"
                                           value="<?= $values ? $values['app_secret'] : ''?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
