                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">公众号支付设置</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require"> 微信公众号支付商户号 MCHID </label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" name="wechat_pay[mchid]"
                                           value="<?= $values ? $values['mchid'] : '' ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require"> 微信公众号支付密钥 APIKEY </label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input"
                                           name="wechat_pay[apikey]"
                                           value="<?= $values ? $values['apikey'] : ''?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
