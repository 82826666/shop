                ...
                <form id="my-form" class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">密码(留空:密码不变)</label>
                                <div class="am-u-sm-9 am-u-end">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="admin[role_id]" required
                                        ...
                                        <?php if (isset($role)): foreach ($role as $first): ?>
                                            <option value="<?= $first['id'] ?>" <?php if($first['id'] == $model['role_id']):?> selected="selected"<?php endif;?>><?= $first['name'] ?></option>
