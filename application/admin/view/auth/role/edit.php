                                        ...
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-u-sm-9 am-u-end">
                                                <?php if($v['child']):foreach ($v['child'] as $key => $val):?>
                                                    <label class="am-checkbox-inline">
                                                        <input class="limit<?php echo $k;?>" type="checkbox" name="Role[act][]" value="<?php echo $val['act'];?>" data-am-ucheck <?php if(in_array($val['act'],$act)) echo "checked";?>>
                                                        <?php echo $val['name'];?>
                                                    </label>
