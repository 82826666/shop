...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, Admin-scalable=no">
    <title>商城系统登录</title>
        ...
        <div class="login-content">
            ...
            <form id="login-form" class="login-form">
                <div class="form-group">
                    <input class="" name="Admin[user_name]" placeholder="请输入用户名" type="text" required>
                </div>
                <div class="form-group">
